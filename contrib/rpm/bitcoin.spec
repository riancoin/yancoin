...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 20331
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 19443
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 20332
...
if [ $1 -eq 0 ]; then
	...
	%{_sbindir}/semanage port -d -p tcp 20331
	%{_sbindir}/semanage port -d -p tcp 19443
	%{_sbindir}/semanage port -d -p tcp 20332
	for selinuxvariant in %{selinux_variants}; do
