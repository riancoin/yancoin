...
"""Verify that starting riancoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start riancoin with -h for help text")
        ...
        self.log.info("Start riancoin with -version for version information")
