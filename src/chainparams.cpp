...
public:
    CMainParams() {
        ...
        assert(consensus.hashGenesisBlock == uint256S("10a6a0f9ba1c3b31c03e0e4ee552f41dfb48e9b1bd327cc16629119ac96acae7"));
        assert(genesis.hashMerkleRoot == uint256S("bb3fb267c2145cd4191f836e8f0d9708d39873d4e76fc2203b401cb82d72d3cf"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        // vSeeds.emplace_back("seed-a.riancoin.loshan.co.uk");
        // vSeeds.emplace_back("dnsseed.thrasher.io");
        // vSeeds.emplace_back("dnsseed.riancointools.com");
        // vSeeds.emplace_back("dnsseed.riancoinpool.org");
...
public:
    CTestNetParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("52a20615664934e65859d9ab6c07d3dd1228ba744395869d83912adbf9f8a814"));
        assert(genesis.hashMerkleRoot == uint256S("bb3fb267c2145cd4191f836e8f0d9708d39873d4e76fc2203b401cb82d72d3cf"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        // vSeeds.emplace_back("testnet-seed.riancointools.com");
        // vSeeds.emplace_back("seed-b.riancoin.loshan.co.uk");
...
public:
    CRegTestParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("65799041fd6814404b3eb63b848500e3cc73f88bd3c72b617aac9ba1d5665efa"));
        assert(genesis.hashMerkleRoot == uint256S("bb3fb267c2145cd4191f836e8f0d9708d39873d4e76fc2203b401cb82d72d3cf"));
