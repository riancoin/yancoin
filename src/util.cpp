...
const char * const BITCOIN_CONF_FILENAME = "riancoin.conf";
const char * const BITCOIN_PID_FILENAME = "riancoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Riancoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Riancoin";
#else
    // Unix
    return pathRet / ".riancoin";
#endif
#endif
}
