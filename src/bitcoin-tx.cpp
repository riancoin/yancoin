...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s riancoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  riancoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded riancoin transaction") + "\n" +
              "  riancoin-tx [options] -create [commands]   " + _("Create hex-encoded riancoin transaction") + "\n" +
              "\n";
