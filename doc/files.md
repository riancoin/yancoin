...
* riancoin.conf: contains configuration settings for riancoind or riancoin-qt
* riancoind.pid: stores the process id of riancoind while running
...
* debug.log: contains debug information and general logging generated by riancoind or riancoin-qt
